...
import { n as cn, o as createLucideIcon } from "./router-Dwu8MerC.mjs";
const __iconNode$2 = [
...
function DataGrid({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("flex min-h-0 flex-1 flex-col", className), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "thin-scrollbar relative flex-1 overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full border-separate border-spacing-0 text-[13px]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "sticky top-0 z-10 bg-surface-2/95 backdrop-blur supports-[backdrop-filter]:bg-surface-2/85", children: table.getHeaderGroups().map((hg) => /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: hg.headers.map((h) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "th",
          {
            ...
            style: { width: h.getSize() !== 150 ? h.getSize() : void 0 },
            children: h.isPlaceholder ? null : /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                ...
                children: [
                  ...
                  canSort && (sorted === "asc" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "size-3" }) : sorted === "desc" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "size-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpDown, { className: "size-3 opacity-40" }))
                ]
              }
            )
          },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: rows.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: columns.length, className: "px-4 py-12 text-center text-[13px] text-muted-foreground", children: empty ?? "No matching records." }) }) : rows.map((row) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          rowKey ? rowKey(original) : row.id
        );
      }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex shrink-0 items-center justify-between gap-3 border-t border-border bg-surface-2 px-3 py-2 text-[12px] text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "num", children: totalRows === 0 ? "No rows" : `${visibleStart.toLocaleString()}–${visibleEnd.toLocaleString()} of ${totalRows.toLocaleString()}` }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "num px-1", children: [
